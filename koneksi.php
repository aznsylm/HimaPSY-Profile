...
// Koneksi ke database
$koneksi = mysqli_connect("localhost", "root", "", "perbankansyariah") or die(mysqli_connect_error());
...
if(isset($_POST['proses'])){
    ...
    $checkQuery = "SELECT * FROM kontak WHERE nim='$nim'";
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        $insertQuery = "INSERT INTO kontak (nama, ponsel, nim, pesan) VALUES ('$nama', '$ponsel', '$nim', '$pesan')";
